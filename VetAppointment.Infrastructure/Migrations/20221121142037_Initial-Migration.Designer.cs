...
namespace VetAppointment.Infrastructure.Migrations
{
    ...
    [Migration("20221121142037_Initial-Migration")]
            ...
            modelBuilder.Entity("VetAppointment.Domain.VetClinic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9b41ce0-63cd-42af-bf45-f9ed397b65c5"),
                            ...
                            NumberOfPlaces = 124,
                            RegistrationDate = new DateTime(2022, 11, 21, 16, 20, 37, 519, DateTimeKind.Local).AddTicks(2149)
                        },
                        new
                        {
                            Id = new Guid("b91ed15a-d3f5-423b-a1ea-22c301a95b2f"),
                            ...
                            Name = "Zoo-Vet",
                            NumberOfPlaces = 64,
                            RegistrationDate = new DateTime(2022, 11, 21, 16, 20, 37, 519, DateTimeKind.Local).AddTicks(2221)
                        });
                });
