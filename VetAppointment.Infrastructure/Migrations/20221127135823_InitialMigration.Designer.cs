...
namespace VetAppointment.Infrastructure.Migrations
{
    ...
    [Migration("20221127135823_InitialMigration")]
            ...
            modelBuilder.Entity("VetAppointment.Domain.VetClinic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("729a9d4b-efd7-4fe4-a4b7-dedc7e2a64d5"),
                            ...
                            NumberOfPlaces = 124,
                            RegistrationDate = new DateTime(2022, 11, 27, 15, 58, 23, 128, DateTimeKind.Local).AddTicks(616)
                        },
                        new
                        {
                            Id = new Guid("f27743ca-62b7-4d15-915f-eb0deb32915d"),
                            ...
                            Name = "Zoo-Vet",
                            NumberOfPlaces = 64,
                            RegistrationDate = new DateTime(2022, 11, 27, 15, 58, 23, 128, DateTimeKind.Local).AddTicks(714)
                        });
                });
