...
namespace VetAppointment.Infrastructure.Migrations
{
    ...
    [Migration("20221121140121_Initial-Migration")]
            ...
            modelBuilder.Entity("VetAppointment.Domain.VetClinic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6169b9ca-42d3-4167-9aae-7829ac9a404c"),
                            ...
                            NumberOfPlaces = 124,
                            RegistrationDate = new DateTime(2022, 11, 21, 16, 1, 20, 968, DateTimeKind.Local).AddTicks(9065)
                        },
                        new
                        {
                            Id = new Guid("82be5ada-7961-40ae-9229-10c89e6b337f"),
                            ...
                            Name = "Zoo-Vet",
                            NumberOfPlaces = 64,
                            RegistrationDate = new DateTime(2022, 11, 21, 16, 1, 20, 968, DateTimeKind.Local).AddTicks(9139)
                        });
                });
